...
<body>
  <main>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
      ...
      $stmt = $mysql->prepare("CALL manager_add_product(:prod_name, :prod_category, :prod_image, :prod_description, :prod_manufacturer, :prod_retail_price, :prod_bulk_price);");
